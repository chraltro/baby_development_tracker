...
const Questionnaire: React.FC<QuestionnaireProps> = ({ chronologicalAge, achievements, onAchievementChange, onPhotoChange, dob }) => {
  ...
  return (
    <>
      ...
      <div>
        ...
        <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2 sm:pr-2 -mr-2 sm:mr-0">
            {relevantMilestones.length === 0 && (
                <p className="text-aurora-text-secondary text-center py-8">
                    No available milestones to log in this category. This may be because more foundational skills need to be logged first to unlock further milestones.
                </p>
            )}
